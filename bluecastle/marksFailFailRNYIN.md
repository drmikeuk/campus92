...
<h2>Fail then resit next year IN attendance</h2>
...
<div class="marksDivider">
 <h2>5: Start next session: List repeating modules + previous modules with marks</h2>
 <h3>2025/26</h3>
 {% assign marks = site.data.bluecastlemarks-mod1-rny  %}{% include bluecastleMarks.html %} 
 <h3>2024/25</h3>
 {% assign marks = site.data.bluecastlemarks-mod1-fail-fail  %}{% include bluecastleMarks.html %}
</div>
