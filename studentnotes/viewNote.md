...
<h2>Robin Hood</h2>
<p>Basic info about this student (ID, plan, visa flag, ... + link to support plan if exists)</p>
...
<table id="DataTable" class="table table-smX table-hover">
  ...
  <tr class=" padRow">
    <td class="right nowrap" data-sort="1">22 Oct 2025</td>
    <td><p>There is no strife, no prejudice, no national conflict in outer space as yet. Its hazards are hostile to us all. Its conquest deserves the best of all mankind, and its opportunity for peaceful cooperation many never come again. But why, some say, the moon? Why choose this as our goal? And they may well ask why climb the highest mountain? Why, 35 years ago, fly the Atlantic? Why does Rice play Texas?</p>
    <p class="actions">Author Name <i class="fas fa-circle"></i> <a href=''>Edit</a></p></td>
  </tr>

  <tr class=" padRow">
    <td class="right nowrap" data-sort="2">4 Oct 2025</td>
...
<a class="btn btn-outline-dark" href="addNote.html" role="button">Add note</a> &nbsp; <a class="btn btn-dark" href="viewList.html" role="button">Back</a>