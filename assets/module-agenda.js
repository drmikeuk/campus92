$(document).ready( function () {
    $('#DataTable').DataTable({
      ...
      $('#changes').on('change', function() {
        ...
        $('#DataTable').DataTable().column(6).search(changes).draw();
      });
      ...
      $('#program').on('change', function() {
        ...
        $('#DataTable').DataTable().column(7).search(program).draw();
      });
} );
